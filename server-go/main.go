...
func (s *server) Create(ct context.Context, req *services.CreateRequest) (*services.Person, error) {
	id := peopleIds
...
func (s *server) Find(ctx context.Context, req *services.LookupRequest) (*services.Person, error) {
	id := req.GetId()
